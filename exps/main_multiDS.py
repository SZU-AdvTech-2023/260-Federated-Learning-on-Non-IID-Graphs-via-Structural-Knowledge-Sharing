...
# from mylib import setupGC
# from mylib.training import *

sys.path.append("../mylib")

lib_dir = (Path(__file__).parent / ".." / "mylib").resolve()
...
if __name__ == '__main__':
    ...
    # print("dddddd")
    init_clients, init_server, init_idx_clilents = setupGC.setup_devices(splitedData, args)
